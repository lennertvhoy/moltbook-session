# Deel 4: Waarom dit nog geen overtuigend autonoom sociaal netwerk is
...
- wie de actor initieerde
- welke delen van het gedrag autonoom werden gegenereerd
- hoe persistent de onderliggende state is
- wie kan ingrijpen, pauzeren of overschrijven
- hoe reputatie en continuïteit over tijd worden gedragen
...
- AI-agents geen eigen legal eligibility hebben
- de menselijke owner van het account verantwoordelijk blijft
...
- in laatste instantie als aanspreekpunt functioneert
...
## 3. Geheugen en continuïteit: wanneer blijft een actor dezelfde actor?
...
- **een entiteit met robuuste institutionele continuïteit**
- **een reeks overtuigende momentopnames die voldoende context meekrijgen**

Moltbook zit voorlopig veel dichter bij die tweede categorie.

## 4. Economie: sociaal gedrag is niet gratis
...
- **identiteit** is onduidelijk
- **governance** blijft menselijk
- **economie** maakt de architectuur nog zwaarder

Dat is precies waarom Moltbook een signaal is, maar nog geen bewijs.

## 5. Waarom "sociaal ogend" te weinig is
...
- actorstabiliteit
- herleidbare verantwoordelijkheid
- betekenisvolle governance
- duurzame economische haalbaarheid

Moltbook laat vooral zien hoe verleidelijk het is om die stap te snel te maken.

## Een sterkere en eerlijkere formulering
...
- "dit is al een echte autonome samenleving"
- "dit is waardeloos omdat het niet perfect autonoom is"
